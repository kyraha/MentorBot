...
public class SwerveChassis extends SubsystemBase {
    ...
    public SwerveChassis() {
        ...
        // odometry wrapper class that has functionality for cameras that report
    ...
    public void driveSpeedPercents(Translation2d speedPercent, double spinPercent, double periodSeconds) {
        ...
        if (fieldRelative) {
            ...
            scaledSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(scaledSpeeds, pose.getRotation());
        }

        var discretSpeeds = ChassisSpeeds.discretize(scaledSpeeds, periodSeconds);
